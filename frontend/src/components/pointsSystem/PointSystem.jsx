    ...
    <div className='container my-24'>
      ...
      <div className='mx-auto my-12 flex lg:flex-row flex-col justify-center gap-14 items-center'>
        <div className='py-4 px-8 border-[1px] border-gray-200 dark:border-gray-600 w-fit lg:h-96 rounded-xl flex flex-col justify-center items-center text-center gap-5 md:gap-8'>
          <h1 className='font-semibold'>Points accumulation</h1>
          <div className='h-[200px] w-[200px] rounded-full relative bg-gray-300 dark:bg-gray-400'>
            <div className='absolute h-[80%] w-[80%] flex justify-center items-center rounded-full bg-white dark:bg-darkmode top-1/2 left-1/2 translate-x-[-50%] translate-y-[-50%]'>
              <div className='text-center'>
                <span className='semibold'>{prog}/500</span><br/>
          ...
          <p className='text-gray-500 darktxt w-[300px]'>Boost your score and unlock 100% benefits just for you!</p>
        </div>
        ...
        <ul className='text-sm text-gray-500 darktxt'>
          <li className='relative'> <IoEllipse className='text-primary absolute left-[-20px] top-0.5'/> +10 points for every confirmed booking.</li> 
          <li className='relative'><IoEllipse color='#2C073D'className='absolute left-[-20px] top-0.5'/> +20 points for bookings longer than 7 days.</li>
          <li className='relative'><IoEllipse color='#39B8E0' className='absolute left-[-20px] top-0.5'/> +20  points with every perfect 5.0 rating!</li>
        </ul>
        </div>
      </div>
      <div>
