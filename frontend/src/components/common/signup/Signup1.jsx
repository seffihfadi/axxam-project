...
function Signup1({ isOpen,setIsOpen, handleClose, openPopup2, inputValue,setInputValue }) {
      ...
      <Popup
        children={
          <div className="w-[80%] mx-auto h-[60vh]">
            <button onClick={handleClose} className="absolute left-4 top-6 text-lg">
              X
            </button>
            <div
            ...
            <form className="pt-14">
              <div className={`group phone ${hasInput && "has-input"}`}>
                <input
                  ...
                  onChange={(event) => {setHasInput(event.target.value !== ""); setInputValue(event.target.value)}}
                />
                <label htmlFor="phonenumber">Phone Number</label>
              </div>
            </form>
            <p className="text-center">
              <span className="font-semibold">Note:</span> We will send an OTP Code
              to the provided number for verification perposes
            </p>
