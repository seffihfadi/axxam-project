      ...
      <section>
        <div className="  py-3 px-0 mx-0 fixed z-50 w-full shadow-lg bg-white dark:bg-darkmode left-0 top-0">
          <div className="px-6 mx-auto flex justify-between items-center gap-[3px] lg:gap-[40px] md:gap-[5px] flex-row">
            ...
            <nav className="flex items-center gap-[5px] lg:gap-[150px] md:gap-[20px] sm:flex-row">
              <div   className={ this.state.clicked  ? "navbar active w-full  items-center font-semibold bg-white dark:bg-darkmode  h-[30px] lg:gap-[35px] md:gap-[10px]  " : "navbar  items-center font-semibold h-[30px] lg:gap-[35px] md:gap-[10px] "} >
