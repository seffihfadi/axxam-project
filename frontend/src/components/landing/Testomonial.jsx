...
const Testomonial = () => {
  return (
    <div className="relative bg-white dark:bg-darkmode shadow-lg p-8 rounded-xl">
      ...
      <div className="flex justify-between items-center pt-6 mt-6 border-t-[1px] border-secondary">
        <div className="user">
          <div className="img">
