    ...
    <section className='landing grid grid-cols-12 gap-10'>
      <div className='order-2 grid grid-cols-12 gap-4 col-span-12 md:col-span-6'>
        <div className='h-[450px] relative col-span-12'>
          ...
          <div className="absolute bg-whitemode rounded-2xl -right-3 -top-3 w-[calc(40%+5rem)] h-[calc(34%+5rem)]">
            <img className='w-[calc(100%-24px)] h-[calc(100%-24px)] mr-3 mt-3 aspect-16/3 ml-auto'  src={data.imgUrl2} alt="img" />
          </div>
        </div>
      </div>
      <div className='col-span-12 md:order-2 md:col-span-6 flex flex-col gap-4 justify-center'>
